...
#ifndef _MZN_CMD_C2_AMASS_H
#define _MZN_CMD_C2_AMASS_H
...
// -------------------------------------------------------------------------- //
class C2Amass : public Command {

friend std::ostream & operator<<(std::ostream & cmd_os, C2Amass const & cmd);
...
public:
    ...
    C2Amass(C2Amass && rhs) = default;
    C2Amass & operator=(C2Amass && rhs) = default;
    C2Amass(C2Amass const & rhs) = default;
    C2Amass & operator=(C2Amass const & rhs) = default;
    std::string const cmd_name = "c2_amass";
...
inline std::ostream & operator<<(std::ostream & cmd_os, C2Amass const & cmd) {
    return cmd.os_print(cmd_os);
}

} // end namespace
#endif // _MZN_CMD_C2_AMASS_H
