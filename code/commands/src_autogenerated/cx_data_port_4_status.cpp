...
namespace mzn {
CxDataPort4Status::CxDataPort4Status():
    Command(0, 28),
...
uint16_t CxDataPort4Status::msg_to_data(std::vector<uint8_t> const & msg,
                                        uint16_t mf_begin) {
...
uint16_t CxDataPort4Status::data_to_msg(std::vector<uint8_t> & msg,
...
std::ostream & CxDataPort4Status::os_print(std::ostream & cmd_os) const {
    cmd_os << "\n --- CX_DATA_PORT_4_STATUS ---  \n";
