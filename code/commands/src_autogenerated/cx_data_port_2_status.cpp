...
namespace mzn {
CxDataPort2Status::CxDataPort2Status():
    Command(0, 28),
...
uint16_t CxDataPort2Status::msg_to_data(std::vector<uint8_t> const & msg,
                                        uint16_t mf_begin) {
...
uint16_t CxDataPort2Status::data_to_msg(std::vector<uint8_t> & msg,
...
std::ostream & CxDataPort2Status::os_print(std::ostream & cmd_os) const {
    cmd_os << "\n --- CX_DATA_PORT_2_STATUS ---  \n";
